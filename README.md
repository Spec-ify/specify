...
The easiest way to build the project is with Visual Studio. Download the most recent version of Visual Studio, launch it with Administrator privileges, 
and use it to open `client/client.sln`.
